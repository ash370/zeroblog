...
var (
	...
	cacheZeroblogArticleArticleIdPrefix = "cache:zeroblogArticle:article:id:"
)
...
func (m *defaultArticleModel) Insert(ctx context.Context, data *Article) (sql.Result, error) {
	zeroblogArticleArticleIdKey := fmt.Sprintf("%s%v", cacheZeroblogArticleArticleIdPrefix, data.Id)
...
func (m *defaultArticleModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheZeroblogArticleArticleIdPrefix, primary)
}
